...
<head>
<meta charset="UTF-8">
<title>Architecture - ALLOLUX AFRICA</title>
...
<div class="container">
    ...
    <p>The ALLOLUX AFRICA application is designed to provide a seamless online fashion shopping experience.</p>
    <ul>
        <li>Frontend: HTML, CSS, JS, user-friendly design.</li>
        <li>Backend: PHP with MySQL database.</li>
        <li>Database: Users, Products, Orders, Order Items, Contact Messages, Admins tables.</li>
        <li>Secure login system for users and admin panel access.</li>
        <li>Interactive features: chat with seller, product filtering, shopping cart, checkout.</li>
        <li>Payments: integrated secure payment methods.</li>
