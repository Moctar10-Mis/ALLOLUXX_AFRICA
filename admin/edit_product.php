...
<head>
<meta charset="UTF-8">
<title>Edit Products - Luxury Pink</title>
<style>
/* ================== Luxury Pink Dashboard ================== */
body {
...
.btn-cart {
    background: linear-gradient(90deg,#f472b6,#d946ef,#9333ea);
}

.btn-cart:hover {
    background: linear-gradient(90deg,#d946ef,#9333ea,#7e22ce);
    transform: translateY(-2px);
}
